...
public class RobotMap {
    ...
    public static Talon cubeIntake;
    public static Talon cubeIntake2;
    public static Talon climberMotor1;
    public static Talon climberMotor2;
	...
	public static void init() {
        ...
        driveSystemfrontLeftMotor.setInverted(true);
        ...
        driveSystembackLeftMotor.setInverted(true);
        LiveWindow.add(driveSystembackLeftMotor);
        
        driveSystembackRightMotor = new Talon(3);
        LiveWindow.add(driveSystembackRightMotor);
       
        cubeIntake = new Talon(4);
        LiveWindow.add(cubeIntake);
        
        cubeIntake2 = new Talon(5);
        LiveWindow.add(cubeIntake2);
        
        climberMotor1 = new Talon(6);
        LiveWindow.add(climberMotor1);
        
        climberMotor2 = new Talon(7);
        LiveWindow.add(climberMotor2);
    }
}
